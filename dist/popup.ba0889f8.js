...
},{"./bundle-url":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/element-ui/lib/theme-chalk/tree.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/element-ui/lib/theme-chalk/base.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"./fonts/element-icons.woff":[["element-icons.c70069ac.woff","../node_modules/element-ui/lib/theme-chalk/fonts/element-icons.woff"],"../node_modules/element-ui/lib/theme-chalk/fonts/element-icons.woff"],"./fonts/element-icons.ttf":[["element-icons.39b714b4.ttf","../node_modules/element-ui/lib/theme-chalk/fonts/element-icons.ttf"],"../node_modules/element-ui/lib/theme-chalk/fonts/element-icons.ttf"],"_css_loader":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/element-ui/lib/locale/lang/zh-CN.js":[function(require,module,exports) {
'use strict';
...
},{}],"../node_modules/element-ui/lib/utils/util.js":[function(require,module,exports) {
'use strict';
...
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/element-ui/lib/locale/format.js":[function(require,module,exports) {
'use strict';
 ...
 */
},{"element-ui/lib/utils/util":"../node_modules/element-ui/lib/utils/util.js"}],"../node_modules/element-ui/lib/locale/index.js":[function(require,module,exports) {
'use strict';
...
},{"element-ui/lib/locale/lang/zh-CN":"../node_modules/element-ui/lib/locale/lang/zh-CN.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js","deepmerge":"../node_modules/deepmerge/dist/cjs.js","./format":"../node_modules/element-ui/lib/locale/format.js"}],"../node_modules/element-ui/lib/mixins/emitter.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/element-ui/lib/checkbox.js":[function(require,module,exports) {
module.exports =
...
/******/ });
},{"element-ui/lib/mixins/emitter":"../node_modules/element-ui/lib/mixins/emitter.js"}],"../node_modules/element-ui/lib/utils/dom.js":[function(require,module,exports) {
'use strict';
...
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/element-ui/lib/transitions/collapse-transition.js":[function(require,module,exports) {
'use strict';
...
},{"element-ui/lib/utils/dom":"../node_modules/element-ui/lib/utils/dom.js"}],"../node_modules/element-ui/lib/utils/merge.js":[function(require,module,exports) {
"use strict";
...
;
},{}],"../node_modules/element-ui/lib/tree.js":[function(require,module,exports) {
module.exports =
/******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
/******/ 	var installedModules = {};
...
/******/ });
},{"element-ui/lib/locale":"../node_modules/element-ui/lib/locale/index.js","element-ui/lib/checkbox":"../node_modules/element-ui/lib/checkbox.js","element-ui/lib/utils/dom":"../node_modules/element-ui/lib/utils/dom.js","element-ui/lib/transitions/collapse-transition":"../node_modules/element-ui/lib/transitions/collapse-transition.js","element-ui/lib/mixins/emitter":"../node_modules/element-ui/lib/mixins/emitter.js","element-ui/lib/utils/merge":"../node_modules/element-ui/lib/utils/merge.js"}],"../node_modules/vue/dist/vue.common.dev.js":[function(require,module,exports) {
var global = arguments[3];
/*!
 * Vue.js v2.6.10
 * (c) 2014-2019 Evan You
...
var _default = {
  ...
  created: function created() {
    ...
    this.getDomain();
    Downloads.onDeterminingFilename.addListener(function (downloadItem, suggest) {
      console.log('onDeterminingFilename', downloadItem);
      suggest({
        filename: "".concat(_this.dir, "/").concat(downloadItem.filename)
      });
    });
    Downloads.onChanged.addListener(function (delta) {
      console.log('onChanged', delta);

      if (delta.state && delta.state.current === 'complete') {
        _this.onComplete(delta.id);
      }
    });
    Downloads.onCreated.addListener(function (item) {
      console.log('onCreated', item);

      _this.onCreated(item.id);
    });
  },
  mounted: function mounted() {
    // 监听事件，获取到images
  ...
  methods: {
    // 下载开始（单个文件
    onCreated: function onCreated(id) {
      //   this.queue.push(id)
      this.all++;
    },
    // 下载结束（单个文件
    onComplete: function onComplete(id) {
      this.d++;
      this.msg = "onComplete, ".concat(this.d, "/").concat(this.all);
      Downloads.erase({
        id: id
      });
    },
    ...
    showDefaultFolder: function showDefaultFolder() {// Downloads.showDefaultFolder();
    }
  }
};
exports.default = _default;
        var $f9aa4a = exports.default || module.exports;
      
      if (typeof $f9aa4a === 'function') {
        $f9aa4a = $f9aa4a.options;
      }
    
        /* template */
        Object.assign($f9aa4a, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("label", [
      ...
      _c("input", {
        ...
        domProps: { value: _vm.dir },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.dir = $event.target.value
          }
        }
      })
    ]),
    ...
    _vm._v(" "),
    _c("section", [
      _c("button", { on: { click: _vm.download } }, [_vm._v("下载")]),
      _vm._v(" "),
      _c("button", { on: { click: _vm.showDefaultFolder } }, [
        _vm._v("打开文件夹")
      ])
    ]),
    _vm._v(" "),
    _c("hr"),
    _vm._v(" "),
    _c("p", { domProps: { textContent: _vm._s(_vm.msg) } })
  ])
}
var staticRenderFns = [
  function() {
    ...
    return _c("section", [
      _c("label", [
        ...
        _vm._v(" "),
        _c("span", [_vm._v("hostname")])
      ]),
      _vm._v(" "),
      _c("label", [
        _c("input", { attrs: { type: "checkbox" } }),
        _vm._v(" "),
        _c("span", [_vm._v("pathname")])
      ])
    ])
  }
]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f9aa4a', $f9aa4a);
          } else {
            api.reload('$f9aa4a', $f9aa4a);
          }
        }
...
},{"vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"popup.js":[function(require,module,exports) {
"use strict";

var _tree = _interopRequireDefault(require("element-ui/lib/theme-chalk/tree.css"));

require("element-ui/lib/theme-chalk/base.css");

var _tree2 = _interopRequireDefault(require("element-ui/lib/tree"));
...
_vue.default.use(_tree2.default);
...
},{"element-ui/lib/theme-chalk/tree.css":"../node_modules/element-ui/lib/theme-chalk/tree.css","element-ui/lib/theme-chalk/base.css":"../node_modules/element-ui/lib/theme-chalk/base.css","element-ui/lib/tree":"../node_modules/element-ui/lib/tree.js","vue/dist/vue.common":"../node_modules/vue/dist/vue.common.js","./app.vue":"app.vue"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","popup.js"], null)
//# sourceMappingURL=/popup.ba0889f8.js.map